...
### Task 2: Drift、build、test verification

**檔案：**
- 修改：`docs/improve/README.md`
- 驗證：`src/generated/`

- [ ] **Step 1: 檢查 generated drift**
