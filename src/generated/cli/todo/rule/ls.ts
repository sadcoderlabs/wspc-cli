...
export const recurrenceRuleListCommand = new Command("ls")
  ...
  .action(async (opts) => {
    ...
    render({ kind: "recurrence_rule_list", display: {"shape":"list","columns":["id","rrule","dtstart","project_id"],"format":{"id":"id-short","rrule":"truncate","project_id":"id-short"},"emptyMessage":"no recurrence rules"} }, result.data)
  })
