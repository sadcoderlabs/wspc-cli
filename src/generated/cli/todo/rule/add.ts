...
export const recurrenceRuleCreateCommand = new Command("add")
  ...
  .action(async (title, opts) => {
    await runSdkCommand({
      operation: recurrenceRuleCreate,
      input: {
        body: {
          title,
      ...
      context: { kind: "recurrence_rule_create", display: undefined },
    })
  })
