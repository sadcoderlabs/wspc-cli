...
export const eventRestoreCommand = new Command("restore")
  ...
  .action(async (id, opts) => {
    await runSdkCommand({
      ...
      context: { kind: "event_restore", display: {"shape":"object","format":{"id":"id-short","user_id":"id-short","status":"status-badge","start":"relative-time","end":"relative-time","created_at":"relative-time","updated_at":"relative-time","deleted_at":"relative-time"}} },
    })
  })
