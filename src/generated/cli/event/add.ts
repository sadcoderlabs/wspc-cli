...
export const eventCreateCommand = new Command("add")
  ...
  .option("--rrule <value>", "Optional RFC 5545 RECUR value without the `RRULE:` prefix. Supports DAILY, WEEKLY, MONTHLY, and YEARLY all-day, UTC, or IANA time-zone recurring series.")
  ...
  .action(async (title, opts) => {
    ...
    await runSdkCommand({
      ...
      context: { kind: "event_create", display: {"shape":"object","format":{"id":"id-short","user_id":"id-short","status":"status-badge","start":"relative-time","end":"relative-time","created_at":"relative-time","updated_at":"relative-time","deleted_at":"relative-time"}} },
    })
  })
