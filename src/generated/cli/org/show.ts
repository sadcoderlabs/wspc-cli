...
export const orgGetCommand = new Command("show")
  ...
  .action(async (opts) => {
    await runSdkCommand({
      ...
      context: { kind: "org_get", display: {"shape":"object","fields":["id","name","created_at","updated_at"],"format":{"id":"id-short","name":"truncate","created_at":"relative-time","updated_at":"relative-time"}} },
    })
  })
